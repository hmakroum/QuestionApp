...
public class QuestionResourceIntTest {
    ...
    private static final QuestionSubject DEFAULT_QUESTION_SUBJECT = QuestionSubject.PERSONNALITE_QUOTIDIEN;
    private static final QuestionSubject UPDATED_QUESTION_SUBJECT = QuestionSubject.FAMILLE_PROJETS;

    private static final String DEFAULT_QUESTION = "AAAAAAAAAA";
    private static final String UPDATED_QUESTION = "BBBBBBBBBB";

    private static final QuestionType DEFAULT_QUESTION_TYPE = QuestionType.BINAIRE;
    private static final QuestionType UPDATED_QUESTION_TYPE = QuestionType.MULTIPLE;
    ...
    public void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].questionSubject").value(hasItem(DEFAULT_QUESTION_SUBJECT.toString())))
    ...
    public void getQuestion() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions/{id}", question.getId()))
            ...
            .andExpect(jsonPath("$.questionSubject").value(DEFAULT_QUESTION_SUBJECT.toString()))
